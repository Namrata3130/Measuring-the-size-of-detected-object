...
default_image_path = "image5.jpg"
default_width = 23.0

# construct the argument parse and parse the arguments
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--image", required=False, default=default_image_path, help="path to the input image")
ap.add_argument("-w", "--width", type=float, required=False, default=default_width, help="width of the left-most object in inches")
